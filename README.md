...
React is a library for building large scale applications with complex state. The 'V' in the MVC, Model-View-Controller, design pattern. It renders UI very well, and handles DOM interactions/updates so performance doesn't suffer. Components are the bread and butter of the operation. They handle the data we pass to them. No matter where it comes from.

- [x] What does it mean to _think_ in react?

Thinking in React is basically compartmentalizing the duties of the application into their respective components and subcomponents.

- [x] Describe state.

State holds our data for us wherever that may come from.

- [x] Describe props.

Props are a means of passing that data to the components that require it.
